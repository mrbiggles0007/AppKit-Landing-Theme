...
<body>
    ...
    <div class="col-2 col-xl-3">
       <img class="img-fluid post-thumb " src=" ../../assets/images/blog/Blog-Link-Images/Hardware/Computer Peripherals.png" alt="image">
    </div>    <div class="col">    <h3 class="title mb-1"><a class="text-link" href="/Blogs/Hardware/TOP LEVEL PAGES/Computer Peripherals.html">Overview Of Computer Peripherals</a></h3>
    <div class="meta mb-1"><span class="date">Published 32 days ago</span><span class="time">5 min read</span>
    <div class="intro">The importance of computer peripherals cannot be overstated, as they play a vital role in modern computing.</div>
    <a class="text-link" href="/Blogs/Hardware/TOP LEVEL PAGES/Computer Peripherals.html">Read more &rarr;</a>
    </div><!--//col-->
    </div><!--//row-->
    </div><!--//item-->
<br></br>
