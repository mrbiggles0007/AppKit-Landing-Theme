...
<body>
    ...
    <div class="col-2 col-xl-3">
       <img class="img-fluid post-thumb " src=" ../../assets/images/blog/Blog-Link-Images/Hardware/Servers.png" alt="image">
    </div>    <div class="col">    <h3 class="title mb-1"><a class="text-link" href="/Blogs/Hardware/TOP LEVEL PAGES/Servers.html">Overview Of Physical Servers</a></h3>
    <div class="meta mb-1"><span class="date">Published 45 days ago</span><span class="time">5 min read</span>
    <div class="intro">A physical server, also known as a bare-metal server, is a physical computer that is dedicated to running one or more services, applications, or processes for one organization. </div>
    <a class="text-link" href="/Blogs/Hardware/TOP LEVEL PAGES/Servers.html">Read more &rarr;</a>
    </div><!--//col-->
    </div><!--//row-->
    </div><!--//item-->
<br></br>
