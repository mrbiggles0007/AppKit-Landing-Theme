...
<script>
  ...
  <!-- Clarity tracking code for https://optimizeddocs.com --><script>    (function(c,l,a,r,i,t,y){        c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};        t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i+"?ref=bwt";        y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);    })(window, document, "clarity", "script", "g13ytvq90o");</script>
    <title>Computer Screens - Index Page</title>
    
    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Computer Screens - Index Page">
...
<body>
    ...
    <div class="col-2 col-xl-3">
       <img class="img-fluid post-thumb " src=" ../../assets/images/blog/Blog-Link-Images/Hardware/Computer Screens.png" alt="image">
    </div>    <div class="col">    <h3 class="title mb-1"><a class="text-link" href="/Blogs/Hardware/TOP LEVEL PAGES/Computer Screens.html">Overview Of Computer Screens</a></h3>
    <div class="meta mb-1"><span class="date">Published 45 days ago</span><span class="time">5 min read</span>
    <div class="intro">Computer screens have come a long way since the first computer monitor, which was invented in 1939 by John V. Atanasoff and Clifford Berry. </div>
    <a class="text-link" href="/Blogs/Hardware/TOP LEVEL PAGES/Computer Screens.html">Read more &rarr;</a>
    </div><!--//col-->
    </div><!--//row-->
    </div><!--//item-->
<br></br>
