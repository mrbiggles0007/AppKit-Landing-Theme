...
<script>
  ...
  <!-- Clarity tracking code for https://optimizeddocs.com --><script>    (function(c,l,a,r,i,t,y){        c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};        t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i+"?ref=bwt";        y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);    })(window, document, "clarity", "script", "g13ytvq90o");</script>
    <title>PC Water Cooling - Index Page</title>
    
    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="PC Water Cooling - Index Page">
...
<body>
   ...
   <div class="item mb-5">
    ...
    <div class="col-2 col-xl-3">
       <img class="img-fluid post-thumb " src=" ../../assets/images/blog/Blog-Link-Images/Hardware/Watercooling Index.png" alt="image">
    </div>    <div class="col">    <h3 class="title mb-1"><a class="text-link" href="/Blogs/Hardware/TOP LEVEL PAGES/Watercooling Index.html">Overview Of PC Water Cooling</a></h3>
    <div class="meta mb-1"><span class="date">Published 19 days ago</span><span class="time">5 min read</span>
    <div class="intro">PC water cooling is a popular method of cooling high-performance computers. It involves using a liquid coolant to transfer heat away from computer components, such as the processor and graphics card, and dissipating it through a radiator. </div>
    <a class="text-link" href="/Blogs/Hardware/TOP LEVEL PAGES/Watercooling Index.html">Read more &rarr;</a>
    </div><!--//col-->
    </div><!--//row-->
    </div><!--//item-->
<br></br>
