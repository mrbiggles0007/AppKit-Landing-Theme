...
<body>
    ...
    <div class="col-2 col-xl-3">
       <img class="img-fluid post-thumb " src=" ../../assets/images/blog/Blog-Link-Images/Consulting/Vendors-Directly-Contacting-Clients.png" alt="image">
    </div>
    <div class="col">
    <h3 class="title mb-1"><a class="text-link" href="/Blogs/Consulting/MSP Vendors/Vendors Directly Contacting Clients.html">Vendors Directly Contacting Clients</a></h3>
    <div class="meta mb-1"><span class="date">Published 1 months ago</span><span class="time">5 min read</span>
    <div class="intro">In recent years, we have seen a concerning trend in the industry where vendors are reaching out directly to our clients, cutting out MSPs from the equation...</div>
    <a class="text-link" href="/Blogs/Consulting/MSP Vendors/Vendors Directly Contacting Clients.html">Read more &rarr;</a>
    </div><!--//col-->
    </div><!--//row-->
    </div><!--//item-->
<br></br>
