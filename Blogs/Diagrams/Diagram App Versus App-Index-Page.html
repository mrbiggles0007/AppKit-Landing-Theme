...
<script>
  ...
  <!-- Clarity tracking code for https://optimizeddocs.com --><script>    (function(c,l,a,r,i,t,y){        c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};        t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i+"?ref=bwt";        y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);    })(window, document, "clarity", "script", "g13ytvq90o");</script>
    <title>Diagram App Versus App - Index</title>
    
    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Diagram App Versus App - Index">
...
<body>
    ...
    <div class="col-2 col-xl-3">
       <img class="img-fluid post-thumb " src=" ../../assets/images/blog/Blog-Link-Images/Diagrams/Visio Versus Lucidchart.png" alt="image">
    </div>
    <div class="col">
    <h3 class="title mb-1"><a class="text-link" href="/Blogs/Diagrams/Diagram App Versus App Topics/Visio Versus Lucidchart.html">Visio Versus Lucidchart</a></h3>
    <div class="meta mb-1"><span class="date">Published 21 days ago</span><span class="time">5 min read</span>
    <div class="intro">Documentation is a crucial part of any Managed Service Providers (MSP) work. It is important to have an organized and standardized documentation system in place to help streamline processes and ensure consistency across all clients. </div>    <a class="text-link" href="/Blogs/Diagrams/Diagram App Versus App Topics/Visio Versus Lucidchart.html">Read more &rarr;</a>
    </div><!--//col-->
    </div><!--//row-->
    </div><!--//item-->
<br></br>
