...
<div class="item mb-5">
    ...
    <div class="col-2 col-xl-3">
       <img class="img-fluid post-thumb " src="../../assets/images/blog/Blog-Link-Images/Security/Security Incidents MSP Topics.webp" alt="Managed Service Provider Security Incidents">
    </div>    <div class="col">    <h3 class="title mb-1"><a class="text-link" href="/Blogs/Security/TOP LEVEL PAGES/Security Incidents Overview.html">Overview Of MSP Security Incidents</a></h3>
    <div class="meta mb-1"><span class="date">Published 3 months ago</span><span class="time">5 min read</span>    <div class="intro">To understand security incidents and their implications for MSPs, it is crucial to review the fundamentals and basics of security incidents.</div>
    <a class="text-link" href="/Blogs/Security/TOP LEVEL PAGES/Security Incidents Overview.html">Read more &rarr;</a>
    </div><!--//col-->
    </div><!--//row-->
    </div><!--//item-->
<br></br>	
