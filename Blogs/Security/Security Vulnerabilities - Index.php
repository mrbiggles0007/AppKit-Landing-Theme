...
<div class="item mb-5">
    ...
    <div class="col-2 col-xl-3">
       <img class="img-fluid post-thumb " src="../../assets/images/blog/Blog-Link-Images/Security/Security Vulnerabilities Topics.webp" alt="Security Vulnerabilities For Managed Service Companies">
    </div>    <div class="col">    <h3 class="title mb-1"><a class="text-link" href="/Blogs/Security/TOP LEVEL PAGES/Security Vulnerability Overview.html">Overview Of Security Vulnerabilities</a></h3>
    <div class="meta mb-1"><span class="date">Published 37 days ago</span><span class="time">5 min read</span>    <div class="intro">One of the key challenges faced by MSPs is ensuring that they are knowledgeable about the various security vulnerabilities that can impact their clients' systems. </div>
    <a class="text-link" href="/Blogs/Security/TOP LEVEL PAGES/Security Vulnerability Overview.html">Read more &rarr;</a>
    </div><!--//col-->
    </div><!--//row-->
    </div><!--//item-->
<br></br>	
