...
<div class="item mb-5">
    ...
    <div class="col-2 col-xl-3">
       <img class="img-fluid post-thumb " src="../../assets/images/blog/Blog-Link-Images/Security/Security Stack Topics.webp" alt="Managed Service Provider Security Stack Topics">
    </div>    <div class="col">    <h3 class="title mb-1"><a class="text-link" href="/Blogs/Security/TOP LEVEL PAGES/Security Stack Overview.html">Overview Of Security Stack</a></h3>
    <div class="meta mb-1"><span class="date">Published 4 months ago</span><span class="time">5 min read</span>    <div class="intro">A security stack is a collection of security tools and technologies that MSPs use to secure their clients' IT infrastructure. </div>
    <a class="text-link" href="/Blogs/Security/TOP LEVEL PAGES/Security Stack Overview.html">Read more &rarr;</a>
    </div><!--//col-->
    </div><!--//row-->
    </div><!--//item-->
<br></br>	
