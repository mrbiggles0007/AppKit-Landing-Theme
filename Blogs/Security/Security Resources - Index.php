...
<div class="item mb-5">
    ...
    <div class="col-2 col-xl-3">
       <img class="img-fluid post-thumb " src="../../assets/images/blog/Blog-Link-Images/Security/Security Resource Topics.webp" alt="Security Resources for Managed Service Providers">
    </div>    <div class="col">    <h3 class="title mb-1"><a class="text-link" href="/Blogs/Security/TOP LEVEL PAGES/Security Resources Overview.html">Overview Of Security Resources</a></h3>
    <div class="meta mb-1"><span class="date">Published 18 days ago</span><span class="time">5 min read</span>    <div class="intro">In recent years, cyber threats have increased in sophistication and frequency, posing a significant challenge to MSPs in ensuring the security and privacy of their clients' data.</div>
    <a class="text-link" href="/Blogs/Security/TOP LEVEL PAGES/Security Resources Overview.html">Read more &rarr;</a>
    </div><!--//col-->
    </div><!--//row-->
    </div><!--//item-->
<br></br>	
